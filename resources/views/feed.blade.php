    ...
    <div class="h-full">
        <nav class="overflow-x-auto [scrollbar-width:none]">
            <ul class="flex min-w-max justify-end gap-8 text-sm">
                ...
                <li>
                    <a class="text-pixel-light/60 hover:text-pixel-light/80" href="#"
                    >Idea streams</a
                    >
                </li>
                <li>
                ...
                <div class="border-pixel-light/10 border-b pb-5">
                    ...
                    <div class="flex items-center justify-between gap-4">
                        <div class="flex items-center gap-2.5">
                            ...
                            <p class="text-pixel-light/40 text-xs">3h</p>
                            <p>
                                <a
                    ...
                    <!-- Post content -->
                    <div
                        class="[&_a]:text-pixel mt-4 flex flex-col gap-3 text-sm [&_a]:hover:underline"
                    >
                        <p>
                    ...
                    <div class="mt-6 flex items-center justify-between gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                <button aria-label="Save" class="hover:text-pixel">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        class="h-[17px]"
                                ...
                                <span class="text-pixel-light/40 text-sm">Save</span>
                            </div>
                            <!-- Share -->
                            <div class="flex items-center gap-1">
                                <button aria-label="Share" class="hover:text-pixel">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        class="h-[17px]"
                    ...
                    >
                        ...
                        <form class="grow" action="">
                            ...
                            <div class="flex items-center justify-between gap-4">
                                ...
                                <button
                                    type="submit"
                                    class="bg-pixel/10 hover:bg-pixel/15 active:bg-pixel/20 text-pixel border border-transparent px-4 py-1 text-sm"
                                >
                                    Post
                                </button>
                            </div>
                        ...
                        <div class="border-pixel-light/10 grow border-b pt-1.5 pb-5">
                            <div class="flex items-center justify-between gap-4">
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <p class="text-pixel-light/40 text-xs">1h</p>
                                    <p>
                                        <a
                                            class="text-pixel-light/40 hover:text-pixel-light/60 text-xs"
                                            href="/profile"
...
>
    <input
        ...
        class="border-pixel-light/50 w-full text-sm"
    />
    ...
    <!-- Follow idea streams -->
    <div class="border-pixel-light/10 mt-4 border p-4">
        <h2 class="text-pixel-light/60 text-sm">Follow Idea Streams</h2>
        <ol class="mt-4 flex flex-col gap-2.5">
            <li class="flex items-center justify-between gap-4">
                <p class="truncate text-sm">Breakfast ideas and whatever</p>
                <button
                    class="bg-pixel-dark/50 hover:bg-pixel-dark/60 active:bg-pixel-dark/75 border-pixel/50 hover:border-pixel/60 active:border-pixel/75 text-pixel grid size-7 shrink-0 place-items-center border text-2xl leading-none"
                >
                    +
                </button>
            </li>
