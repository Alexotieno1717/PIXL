        ...
        <div class="border-pixel-light/10 border-b pb-5">
            ...
            <div class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-2.5">
                    ...
                    <p class="text-pixel-light/40 text-xs">{{ $item->postedDateTime }}</p>
                    <p>
                        <a
            ...
            <div class="mt-6 flex items-center justify-between gap-4">
                <div class="flex items-center gap-8">
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        <span class="text-sm">{{ $item->likesCount }}</span>
                    </div>
                    <!-- Comment -->
                    <div class="flex items-center gap-1">
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        <span class="text-sm">{{ $item->repostsCount }}</span>
                    </div>
                </div>
            ...
            >
                ...
                @include('partials.post-form', ['labelText' => 'Reply body', 'fieldName' => 'reply', 'placeholder' => "Reply to {$item->profile->displayName} post", 'rows' => 5])
            </div>
        </div>
        <!-- Threaded replies -->
        <ol>
